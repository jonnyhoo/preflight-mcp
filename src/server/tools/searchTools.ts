...
const SearchAndReadOutputSchema = z.object({
  ...
  data: z.object({
    ...
    hits: z.array(z.object({
      ...
      matchRange: z.object({ startLine: z.coerce.number(), endLine: z.coerce.number() }),
      excerptRange: z.object({ startLine: z.coerce.number(), endLine: z.coerce.number() }),
      excerpt: z.string(),
