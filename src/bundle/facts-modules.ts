 ...
 *
 * Functions for analyzing module dependencies, architecture patterns,
 * and technology stack in ingested repositories.
 *
 * @module bundle/facts-modules
 */
...
// ============================================================================
// Export/Import Extraction (Regex Fallback)
// ============================================================================
...
/**
 * Internal type for repo file indexes
 */
type RepoIndexes = {
 ...
 */
export async function analyzeModules(files: IngestedFile[]): Promise<ModuleInfo[]> {
